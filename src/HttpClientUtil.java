...
public class HttpClientUtil {
    //定制请求配置信息内容
    private RequestConfig requestConfig = RequestConfig.custom()  //定制请求配置
    ...
    public String sendHttpPost(String httpUrl, Map<String, String> maps,String type) {  
        HttpPost httpPost = new HttpPost(httpUrl);//根据url创建一个http 请求对象
        // 创建参数队列    
     ...
     * @return 
     */  
    private String sendHttpPost(HttpPost httpPost,String responseType) {
        ...
        try {  
            ...
            responseContent = EntityUtils.toString(entity, responseType);
